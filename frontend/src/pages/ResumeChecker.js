  ...
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '32px', fontFamily: '"Inter", "Space Grotesk", sans-serif', width: '100%', minHeight: '100vh' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
        <div>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', margin: '0 0 8px 0', color: 'var(--text-main)', letterSpacing: '-0.5px' }}>Decode the Resume</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', gridAutoFlow: 'dense' }}>
        <div className="ats-card" style={{ gridColumn: 'span 2', padding: '32px', borderRadius: '24px', display: 'flex', flexDirection: 'column', transition: 'all 0.4s ease-in-out' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
             <h3 style={{ margin: 0, color: 'var(--text-main)', fontSize: '1.2rem', fontWeight: '600' }}>Raw DNA Input</h3>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="ats-card" style={{ padding: '32px', borderRadius: '24px', transition: 'all 0.4s ease-in-out' }}>
            <h3 style={{ margin: '0 0 24px 0', color: 'var(--text-main)', fontSize: '1.2rem', fontWeight: '600' }}>Sequencing Depth</h3>
            <div style={{ marginBottom: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px', color: 'var(--text-main)', fontSize: '0.95rem' }}>
          ...
          <div className="ats-card" style={{ padding: '32px', borderRadius: '24px', flexGrow: 1, transition: 'all 0.4s ease-in-out' }}>
            <h3 style={{ margin: '0 0 24px 0', color: 'var(--text-main)', fontSize: '1.2rem', fontWeight: '600' }}>ATS Metrics</h3>
            {analysisResult ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                <div>
                ...
                <div>
                  ...
                  <ul style={{ margin: 0, paddingLeft: '0', listStyle: 'none', color: 'var(--text-muted)', fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ color: 'var(--text-muted)', fontSize: '0.95rem', fontStyle: 'italic', display: 'flex', alignItems: 'center', gap: '8px' }}>
